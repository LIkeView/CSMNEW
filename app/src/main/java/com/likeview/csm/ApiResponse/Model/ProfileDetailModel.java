...
public class ProfileDetailModel {
    public ProfileDetailModel(int userId, String name, String userName, String mobile, String email, String profilePic, String profilePicPath, String gender, String webUrl, String companyName, String profession, String address, String city, String state, String country, String pinCode, String status, String createdDate, String updatedDate) {
        this.userId = userId;
        this.name = name;
